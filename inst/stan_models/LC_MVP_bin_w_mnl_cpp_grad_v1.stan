...
vector   Stan_wrapper_lp_fn_var(      int Model_type_int, 
...
transformed parameters {
     ...
     if (n_class > 1) {
         ...
         prev_var_matrix = lb_ub_lp(prev_unconstrained_matrix, 0.0, 1.0, log_det_J_main_indicator);
     }
...

    {
            ...
            for (c in 1:n_class) {
                    ...
                    L_Omega[c, :  ] =   cholesky_corr_constrain_outer_lp( col_one_raw[c, :], off_raw[c, :], lb, ub, log_det_J_main_indicator);
                    ...
                    if (priors_via_Stan == 1) {
                        ...
                        log_lik =           Stan_wrapper_lp_fn_var(     Model_type_int, /// model_type
                                                                        multi_attempts_int, /// multi_attempts (1 for MVP, 2 for LC_MVP, 3 for latent_trait)
                                                                        theta_main_vec,
                                                                        theta_nuisance_vec,
                                                                        y,
                                                                        n_chunks_target,
