...
# callr::r(func = before_restart, args = list(pkg_dir))
# 
# ## rstudioapi::restartSession()
# ## Install (inner pkg):
# require(BayesMVP)
...
# # install.packages("systemfonts", configure.vars="INCLUDE_DIR=/usr/include/freetype2:/usr/include/fontconfig LIB_DIR=/usr/lib/x86_64-linux-gnu")
