...
double                                   fn_find_initial_eps_main(          Eigen::Matrix<double, -1, 1> theta_main_vec_initial_ref,
      ...
      return fn_find_initial_eps_main(   result_input,
...
double                                   fn_find_initial_eps_us(            Eigen::Matrix<double, -1, 1> theta_main_vec_initial_ref,
  ...
  HMCResult result_input(n_us, n_params, N);
  result_input.us_theta_vec = theta_us_vec_initial_ref;
  result_input.us_theta_vec_0 = theta_us_vec_initial_ref;
  ...
  return fn_find_initial_eps_us(     result_input,
                                     seed, burnin,  Model_type,  
                                     force_autodiff, force_PartialLog, multi_attempts, 
                                     y_ref,
                                     Model_args_as_cpp_struct,  EHMC_args_as_cpp_struct, EHMC_Metric_as_cpp_struct);
...
Rcpp::List                                   Rcpp_fn_RcppParallel_EHMC_sampling(  const int n_threads_R,
 ...
 /// NumericMatrix  other_main_out_vector_all_chains_output_to_R(10, n_threads_R);  // write to this
  ...
  std::vector<NumericMatrix> trace_output_divs = vec_of_mats_Rcpp(1, n_iter_R, n_threads_R);
  ...
  std::vector<Eigen::Matrix<float, -1, -1>> trace_output_log_lik = vec_of_mats<float>(N, n_iter_R, n_threads_R);
   ...
   parallel_hmc_sampling.copy_results_to_output(); ////  To copy / store trace
